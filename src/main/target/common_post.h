...
#include "serial_post.h"
    ...
    && !defined(USE_ACCGYRO_SPI_BMI088) \
...
// Generate USE_SPI_GYRO
    ...
    || defined(USE_ACCGYRO_SPI_BMI088) || defined(USE_ACCGYRO_LSM6DSV16X) || defined(USE_ACCGYRO_LSM6DSO) || defined(USE_ACCGYRO_ICM40609D) || defined(USE_ACCGYRO_IIM42652)
#ifndef USE_SPI_GYRO
#define USE_SPI_GYRO
#endif
#endif
